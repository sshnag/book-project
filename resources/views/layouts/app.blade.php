...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" rel="stylesheet">    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
</head>
    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-md-4">
                ...
                <a href="https://www.facebook.com/" class="text-white me-3 footer-icon" ><i class="fab fa-facebook fa-lg"></i></a>
                <a href="https://instagram.com/" class="text-white me-3 footer-icon" ><i class="fab fa-instagram fa-lg"></i></a>
                <a href="https://www.whatsapp.com/" class="text-white me-3 footer-icon"><i class="fab fa-whatsapp fa-lg"></i></a>
            </div>
