        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="card custom-card border-0 shadow">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted">We’d love to hear from you! Fill out the form below and we'll get back to you
                            soon.</p>
            ...
            <div class="col-md-6">
                <div class="position-relative overflow-hidden rounded shadow">
                    <img src="{{ asset('images/hero2.jpg') }}" alt="Contact Us" class="img-fluid w-100"
                        style="object-fit: cover; min-height: 610px;">

                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-start text-white p-4"
