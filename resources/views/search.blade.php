        ...
        @if ($books->count())
            <div class="list-group">
                @foreach ($books as $book)
                    <div
                        class="list-group-item py-4 px-3 mb-3 shadow-sm rounded d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between transition-transform hover-scale search-result-item">
